...
class Visualizer extends AMEPluginHelper {
    ...
    loadJS(url, fn = () => {}, location = document.body) {
...
/** Change this to your new class name */
new Visualizer()
var AMEx = {
...
var _amOT = {
    ...
    VizConfig: function () {
        ...
        closeVizBtn.style.background = "var(--genericJoeColor)"
        closeVizBtn.style.borderRadius = "4px"
        closeVizBtn.style.padding = "8px 0px 8px 0px"
        closeVizBtn.style.width = "100%"
        closeVizBtn.style.fontWeight = "bold"
